...
const checks = [
  ...
  { name: "User verify email", method: "POST", path: "/api/v1/user/verify-email", body: {}, expect: [400] },
  { name: "User verify email legacy alias", method: "POST", path: "/api/v1/user/verifyEmail", body: {}, expect: [400] },
  { name: "User resend OTP", method: "POST", path: "/api/v1/user/resend-otp", body: {}, expect: [400] },
  { name: "User forgot password", method: "POST", path: "/api/v1/user/forgot-password", body: {}, expect: [400] },
  { name: "User reset password", method: "POST", path: "/api/v1/user/reset-password", body: {}, expect: [400] },
  ...
  { name: "Company top", method: "GET", path: "/api/v1/company/top", expect: [200] },
  ...
  { name: "Jobs categories", method: "GET", path: "/api/v1/jobs/categories", expect: [200] },
  { name: "Jobs featured", method: "GET", path: "/api/v1/jobs/featured", expect: [200] },

  ...
  return (
    <div className="jc-soft-page min-h-screen p-4 sm:p-6">
      <div className="mb-6 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="font-serif text-2xl font-bold text-[#261723] sm:text-3xl">
      ...
      <section className="mb-6 grid gap-4 lg:grid-cols-3">
        <div className="jc-panel p-5 lg:col-span-2">
          <div className="mb-4 flex items-center gap-2">
            <ShieldCheck className="h-5 w-5 text-[#5d0f51]" />
        ...
        <div className="jc-panel p-5">
          <div className="mb-4 flex items-center gap-2">
            <Gauge className="h-5 w-5 text-[#5d0f51]" />
            <h2 className="text-lg font-bold text-[#261723]">
          ...
          {usage?.hasSubscription ? (
            usage.isUnlimited ? (
              <div className="flex items-center gap-3 rounded-lg bg-[#f7eef9] p-4 text-[#261723]">
              ...
              <div>
                ...
                <div className="h-3 overflow-hidden rounded-full bg-gray-100">
                  <div className="h-3 rounded-full bg-[#5d0f51]" style={{ width: `${usagePercent}%` }} />
                </div>
      ...
      <section className="mb-6">
        <div className="mb-4 flex items-center gap-2">
          <BadgeIndianRupee className="h-5 w-5 text-[#5d0f51]" />
          <h2 className="text-xl font-bold text-[#261723]">
            {t("subscription:choosePlan", { defaultValue: "Choose Plan" })}
          </h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {plans.map((plan) => (
            <article key={plan._id} className="jc-panel p-5">
              <div className="mb-4">
                <h3 className="text-lg font-bold text-[#261723]">
              ...
              <button
                ...
                className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#5d0f51] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#3f0b38] disabled:cursor-not-allowed disabled:opacity-60"
              >
      ...
      <section className="jc-panel p-5">
        <div className="mb-4 flex items-center gap-2">
          <History className="h-5 w-5 text-[#5d0f51]" />
          <h2 className="text-xl font-bold text-[#261723]">
...
function Metric({ icon, label, value }) {
  return (
    <div className="rounded-lg border border-[#f0dce8] bg-[#fff7fb] p-4">
      <div className="mb-2 flex items-center gap-2 text-[#5d0f51]">{icon}</div>
      <p className="text-xs font-semibold uppercase text-[#7b6575]">{label}</p>
      <p className="mt-1 text-base font-bold capitalize text-[#261723]">{value || "-"}</p>
    </div>
  );
}
